...
export type Database = {
  public: {
    Tables: {
      ...
      room_members: {
        Row: {
          ...
          consecutive_success_count: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "room_members_alarm_id_fkey"
            columns: ["alarm_id"]
            isOneToOne: false
    ...
    Enums: {
      alarm_status_enum: "pause" | "standby" | "success" | "failure" | "ringing"
      ...
      request_type_enum:
        ...
        | "leave_request"
        | "deactivate_request"
      room_member_status: "active" | "inactive" | "invited" | "skipping"
